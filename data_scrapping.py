...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
	...
	#url = 'https://www.glassdoor.com/Job/jobs.htm?context=Jobs&suggestCount=0&suggestChosen=false&clickSource=searchBox&typedKeyword="'+keyword+'"&locId=115&locT=N&sc.keyword=Data%20Scientist'
    url = 'https://www.glassdoor.com/Job/jobs.htm?context=Jobs&suggestCount=0&suggestChosen=false&clickSource=searchBox&typedKeyword=Data%20Scientist&locId=115&locT=N&sc.keyword=Data%20Scientist'
    driver.get(url)
    jobs = []
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        if not (len(jobs) >= num_jobs):
            ...
            for job_button in job_buttons:  
                ...
                #add job to jobsprint(currentJoblist)
